...
public class Book {
    ...
    private Integer state;          //书籍状态 0表示不可以借 1表示可以借
    ...
    public Book(Integer id, String name, String author, String date, String press, Integer price, Integer state, String comment) {
        this.id = id;
        this.name = name;
        this.author = author;
        this.date = date;
